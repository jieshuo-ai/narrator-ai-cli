...
👉 **安装 Skill**：[narrator-ai-cli-skill](https://github.com/jieshuo-ai/narrator-ai-cli-skill)
...
详见 [narrator-ai-cli-skill](https://github.com/jieshuo-ai/narrator-ai-cli-skill)，包含完整的 SKILL.md 文件，让 AI Agent 自动理解如何使用本工具。
